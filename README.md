...
```
make a functino that returns true if the string is a palindrome, if not return false.(if the word is the same as the word in reverse, it should return true)
```
